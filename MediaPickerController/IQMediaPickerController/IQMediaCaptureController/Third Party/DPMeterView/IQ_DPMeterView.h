...
typedef NS_ENUM(NSInteger, IQ_DPMeterType) {
    IQ_DPMeterTypeLinearNone,
    IQ_DPMeterTypeLinearVertical,              // default
    IQ_DPMeterTypeLinearHorizontal,
...
@interface IQ_DPMeterView : UIView <UIAppearance>

@property (nonatomic) IQ_DPMeterType meterType;
